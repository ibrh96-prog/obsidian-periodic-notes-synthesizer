...
This End User License Agreement ("Agreement") is a legal agreement between you ("you" or "the user") and the developer of Periodic Notes Synthesizer ("the Software"). By installing, activating, or using the Software, you agree to the terms of this Agreement. If you do not agree, do not use the Software.
...
The Software has no server, no database, and no telemetry, and the developer performs no backend data collection. The Software transmits your note content to the language model provider you configure, using your own key, for the purpose of generating synthesis output. The developer does not receive, store, or have access to your notes, API key, or any usage data.
